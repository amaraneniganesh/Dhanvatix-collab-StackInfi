    ...
    <div className="min-h-screen bg-[#09090b] text-slate-200 font-sans selection:bg-teal-500/30">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden min-h-[85vh] flex flex-col items-center justify-center text-center">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-xs font-medium text-teal-300 mb-8">
            ...
            <span>Introducing Dhanvatix & StackInfi Subdomains</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-3xl mb-10 leading-relaxed">
            Say goodbye to outdated domain registrars. Build your digital infrastructure with premium domains like <strong className="text-white">.dhanvatix.in</strong> and <strong className="text-white">.stackinfi.in</strong>. Smart, intuitive. And never boring.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-slate-400 text-lg leading-relaxed">
              Domain management shouldn't be a massive puzzle. Dhanvatix is a flexible toolkit that makes every digital infrastructure task feel like a breeze.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#18181b] border border-white/10 rounded-3xl p-8 hover:bg-[#1f1f22] transition-colors group">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Claim your unique identity on the web instantly. Grab <code className="text-teal-400 bg-teal-400/10 px-1 py-0.5 rounded">.dhanvatix.in</code> or <code className="text-teal-400 bg-teal-400/10 px-1 py-0.5 rounded">.stackinfi.in</code> before anyone else does.
            </p>
          </div>
          ...
          <div className="bg-[#18181b] border border-white/10 rounded-3xl p-8 hover:bg-[#1f1f22] transition-colors group">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Security shouldn't be an add-on. Every Dhanvatix domain is automatically provisioned with a free, auto-renewing SSL certificate.
            </p>
          </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-6 relative z-10">
          ...
          <Link to="/login" className="inline-flex px-8 py-4 rounded-full bg-white text-black font-bold hover:bg-slate-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]">
            Create Free Account
          </Link>
        </div>
      </section>
      ...
      <footer className="border-t border-white/10 bg-[#09090b] py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-white tracking-wide">Dhanvatix</span>
          </div>
          ...
          <div className="text-sm text-slate-600">
            © {new Date().getFullYear()} Dhanvatix Inc. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
