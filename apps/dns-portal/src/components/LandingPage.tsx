    ...
    <div className="min-h-screen bg-[#09090b] text-slate-200 font-sans selection:bg-teal-500/30">
      ...
      <nav className="fixed top-0 w-full border-b border-white/5 bg-[#09090b]/80 backdrop-blur-md z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-6">
            <a href={`${MAIN_PORTAL_URL}/login`} className="text-sm font-medium text-slate-400 hover:text-white transition-colors hidden sm:block">
              Log in
            </a>
            <a href={`${MAIN_PORTAL_URL}/login`} className="text-xs sm:text-sm font-medium bg-white text-black px-3 sm:px-4 py-2 rounded-full hover:bg-slate-200 transition-colors flex items-center gap-1.5 whitespace-nowrap">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden min-h-[85vh] flex flex-col items-center justify-center text-center">
        ...
        <div className="relative z-10 flex flex-col items-center px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 w-full sm:w-auto">
            <a href={`${MAIN_PORTAL_URL}/login`} className="w-full sm:w-auto px-8 py-4 rounded-full bg-white text-black font-semibold hover:bg-slate-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] flex items-center justify-center gap-2">
              Claim your domain <ChevronRight className="w-4 h-4" />
            </a>
            <a href="#features" className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/5 border border-white/10 text-white font-semibold hover:bg-white/10 transition-all text-center">
              Explore features
            </a>
          </div>
        </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-6 relative z-10">
          ...
          <a href={`${MAIN_PORTAL_URL}/login`} className="inline-flex px-8 py-4 rounded-full bg-white text-black font-bold hover:bg-slate-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] items-center gap-2">
