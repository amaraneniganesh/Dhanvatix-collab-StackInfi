...
export default function DNSManager({ domainId, rootDomain, onBack }: DNSManagerProps) {
  ...
  return (
    <div className="animate-in fade-in duration-500">
      <button
        onClick={onBack}
        className="mb-4 sm:mb-6 flex items-center gap-2 text-slate-400 hover:text-white transition font-bold text-sm sm:text-base"
      >
        <ArrowLeft size={16} />
        Back to Overview
      </button>
      ...
      <div className="bg-[#121214] rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border border-white/5 shadow-xl relative overflow-hidden">
        ...
        <form onSubmit={handleAddRecord}>
          {/* Mobile: single column stacked form. Tablet: 2 columns. Desktop: full 12-col Cloudflare layout. */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 items-end">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full p-2.5 sm:p-3 rounded-xl border border-white/10 bg-black/40 text-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none transition-all appearance-none font-medium text-sm"
                >
            ...
            <div className="lg:col-span-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-2.5 sm:p-3 rounded-xl border border-white/10 bg-black/40 text-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none transition-all font-mono text-sm"
                />
              </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center gap-4 mt-1 sm:mt-3">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-11 h-6 bg-slate-800 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-orange-500 border border-white/10 shrink-0"></div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full p-2.5 sm:p-3 rounded-xl border border-white/10 bg-black/40 text-white focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none transition-all appearance-none text-sm font-medium"
                >
          ...
          <div className="mt-5 sm:mt-6 flex flex-col sm:flex-row justify-end gap-3 pt-5 sm:pt-6 border-t border-white/5">
            <button
              type="submit"
              disabled={isAdding}
      ...
      <div className="bg-[#121214] rounded-2xl border border-white/5 overflow-hidden shadow-xl">
        <div className="p-4 sm:p-6 border-b border-white/5 flex flex-wrap justify-between items-center gap-3">
          ...
          <div className="text-xs sm:text-sm font-medium text-slate-500 bg-black/40 px-3 py-1 rounded-full border border-white/5">
